...
async function main() {
    ...
    await vesting.connect(deployer).createVestingSchedule(vestingSchedule[2]['beneficiary'], vestingSchedule[2]['vestAmount'],
    vestingSchedule[2]['vestingPeriod'], 
    vestingSchedule[2]['releaseAmount']); 
