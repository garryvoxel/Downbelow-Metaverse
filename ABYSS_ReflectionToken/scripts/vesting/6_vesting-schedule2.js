...
async function main() {
    ...
    await vesting.connect(deployer).createVestingSchedule(vestingSchedule[1]['beneficiary'], vestingSchedule[1]['vestAmount'],
    vestingSchedule[1]['vestingPeriod'], 
    vestingSchedule[1]['releaseAmount']); 
