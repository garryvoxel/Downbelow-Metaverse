...
async function main() {
    ...
    await vesting.connect(deployer).createVestingSchedule(vestingSchedule[0]['beneficiary'], vestingSchedule[0]['vestAmount'],
    vestingSchedule[0]['vestingPeriod'], 
    vestingSchedule[0]['releaseAmount']); 
