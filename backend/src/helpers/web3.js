...
module.exports.getTransaction = async function(hash){
    ...
    if(transaction){
        ...
        if(transaction.input != '0x'){
            ...
            transaction.input.inputs[1] = transaction.input.inputs[1].toString();
            transaction.value = web3.utils.fromWei(transaction.input.inputs[1]);
            transaction.to = `0x${transaction.input.inputs[0]}`;
        }
        else{
...
module.exports.getTransactionReceipt = async function(hash){
